...
| S12 — Higiene de repo & build | ✅ | 2026-06-23 | chore/repo-hygiene | `.gitattributes` (`* text=auto eol=lf` + binários), `.nvmrc` (`22`), `engines` `>=22 <23` no `package.json`. `git add --renormalize .` normaliza os 69 arquivos de ruído EOL. README + CLAUDE atualizados. |
