...
| ------------------- | ------ | ---- | --------- | ------------------------------------------- |
| S1 — P0 Indexação   | ✅     | 2026-06-19 | __HASH__  | Opção A: `/blog/:slug` Prerender + `getPrerenderParams`; rebuild ao publicar documentado |
| S2 — Quick wins     | ⬜     | —    | —         |                                             |
...
- ✅ `/blog/:slug` → `Prerender` com `getPrerenderParams()` lendo slugs do Supabase _(2026-06-19, `__HASH__`)_
